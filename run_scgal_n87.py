...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=200, help='number of epoches to train the GAN_AE.')
    ...
    parser.add_argument('--dir_A', type=str, default='./data/NCI-N87/N87_dna.csv')
    parser.add_argument('--dir_B', type=str, default='./data/NCI-N87/N87_rna.txt')
